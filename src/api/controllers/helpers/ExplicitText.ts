...
export const flaggedWords = [
    ...
    'allahu akbar', "Molana", "Maulana", "Palestine", "Palestinians", "Palestinian", "Mulla", "Dalla", "Khuda", "Islam", "Allahu Akbar", "Agbar", "Allah", "Maula", "Khalistan", "Kashmir", "zindabad", "murdabad", "sikhs for justice", "RSS", "Hinduphobia", "Islamophobia", "sikhs", "religion", "religious",
    "Rape", "Brahman", "Pandit", "Shudar", "vaishya", "kshatriya", "Allhamdullilah", "We want justice", "Black live matters", "Black live", "All live matters", "LOC", "POK", "Prophet", "Hajj", "Haj", "Shit", "Murder", "zihaad", "zihad", "allahu", "alahu", "aqbar", "filistine", "filisteen", "Killer", "bom", "boomb", "bomb", "blast", "blaast", "allahamdullilah", "aatank", "atank", "maqsad", "militent", "militant", "aatankwaad", "attakwad", "attankwadi", "atankwadi", "aatankwaadi",
