...
import {
  ...
  uploadMiddleware,
  VoteInPoll,
} from '@/api/controllers/posts/UserPost';
import {
  getComments,
  getNestedComments,
  deleteComment,
  ...
  createOrUpdateNestedComment,
  getCommentLikeUserList,
  commentDocumentMiddleware,
} from '@/api/controllers/posts/CommentController';
import {
  createLike,
  getAllLikesForPost,
  createCommentLike,
  createNestedCommentLike,
  getAllLikesForComment,
  getUserPostLikeList,
  getPostCommentersList,
} from '@/api/controllers/posts/LikeController';
...
Router.post('/create-comment', authenticate, commentDocumentMiddleware, createOrUpdateComment);
